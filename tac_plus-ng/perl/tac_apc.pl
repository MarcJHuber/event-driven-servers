...
#
# Sample AuthorizedPrincipalsCommand OpenSSH script for user cert validationvia tac_plus-ng.
# This is a PoC only.
#
# Usage: tac_akc.pl [options] <user>
#
# Suitable sshd_config snippet:
#  AuthorizedPrinciapalsCommand /where/ever/tac_apc.pl %u %i
#  AuthorizedPrincipalsCommandUser whoever
#
...
my $pkt = Net::TacacsPlus::Packet->new(
	...
	'session_id' => int rand 0xffffffff,
 	'authen_method' => 6, # T+
	'authen_type' => 9, # TAC_PLUS_AUTHEN_TYPE_SSHCERT
	'user' => $username,
	'key' => $key,
	'rem_addr' => $rem_addr,
	'port' => $rem_port,
