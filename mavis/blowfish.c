/*
 * Blowfish routines for *aligned* data.
 * (C)1999-2011 Marc Huber <Marc.Huber@web.de>
 *
 * Blowfish algorithm (C) Bruce Schneier.
 * The tables below were extracted from Bruce Schneier's Blowfish.dat.
 *
 * Go for the SSLeavy package if you want a portable and robust
 * implementation.
 *
 * Take care, I haven't even verified that this code produces the
 * same results as other implementations, but at least the results
 * are symmetric ;-)
 *
 * $Id$
 *
...
static unsigned int P_array[] = {
    0x243f6a88, 0x85a308d3, 0x13198a2e, 0x03707344, 0xa4093822, 0x299f31d0,
    0x082efa98, 0xec4e6c89, 0x452821e6, 0x38d01377, 0xbe5466cf, 0x34e90c6c,
    0xc0ac29b7, 0xc97c50dd, 0x3f84d5b5, 0xb5470917, 0x9216d5d9, 0x8979fb1b
};

static unsigned int S_box0[] = {
...
static void Blowfish_enc(struct blowfish_ctx *ctx, u_int * xL_out, u_int * xR_out, u_int xL, u_int xR)
{
    ...
    *xR_out = xR ^ ctx->P_array[16], *xL_out = xL ^ ctx->P_array[17];
}
...
static void Blowfish_dec(struct blowfish_ctx *ctx, u_int * xL_out, u_int * xR_out, u_int xL, u_int xR)
{
    ...
    *xR_out = xR ^ ctx->P_array[1], *xL_out = xL ^ ctx->P_array[0];
}
...
struct blowfish_ctx *blowfish_init(char *key, size_t keylen)
{
    ...
    ctx = Xcalloc(1, sizeof(struct blowfish_ctx));

    memcpy(ctx->P_array, P_array, (size_t) 18);
    memcpy(ctx->S_box0, S_box0, (size_t) 256);
    memcpy(ctx->S_box1, S_box1, (size_t) 256);
